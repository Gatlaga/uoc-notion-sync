...
// Vercel Cron hits this on a schedule (see vercel.json) — no auth needed for
// the cron itself, but we still check a shared secret so no one else can
// trigger it and burn your Notion rate limit.
